...
export const DriverIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 18.75a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m3 0h6m-9 0H3.375a1.125 1.125 0 01-1.125-1.125V14.25m17.25 4.5a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m3 0h1.125c.621 0 1.125-.504 1.125-1.125V14.25m-17.25 4.5v-1.875a3.375 3.375 0 013.375-3.375h9.75a3.375 3.375 0 013.375 3.375v1.875m-17.25 4.5h14.25M5.25 6.375c0-1.036.84-1.875 1.875-1.875h.375c.621 0 1.125.504 1.125 1.125v4.125c0 .621-.504 1.125-1.125 1.125h-.375C6.09 11.25 5.25 10.41 5.25 9.375V6.375zm13.5 0c0-1.036-.84-1.875-1.875-1.875h-.375c-.621 0-1.125.504-1.125 1.125v4.125c0 .621.504 1.125 1.125 1.125h.375c1.035 0 1.875-.84 1.875-1.875V6.375z" />
    </svg>
);
...
export const GoogleIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="48px" height="48px" {...props}>
        ...
        <path fill="#1976D2" d="M43.611,20.083H42V20H24v8h11.303c-0.792,2.237-2.231,4.166-4.087,5.574l6.19,5.238C41.38,36.463,44,30.663,44,24C44,22.659,43.862,21.35,43.611,20.083z" />
    </svg>
);
...
export const UsersIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M15 19.128a9.38 9.38 0 002.625.372 9.337 9.337 0 004.121-.952 4.125 4.125 0 00-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 018.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0111.964-4.663M12 3.375c-3.418 0-6.162 2.613-6.162 5.823 0 3.21 2.744 5.823 6.162 5.823s6.162-2.613 6.162-5.823c0-3.21-2.744-5.823-6.162-5.823z" />
    </svg>
);
...
export const FuelIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 7.5h7.5v1.5h-7.5v-1.5z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M4.502 9.75a4.5 4.5 0 014.5-4.5h6.496a4.5 4.5 0 014.5 4.5v1.5a.75.75 0 01-.75.75h-15a.75.75 0 01-.75-.75v-1.5z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M5.25 12v.75a.75.75 0 00.75.75h12a.75.75 0 00.75-.75v-.75m-15 3.75a.75.75 0 00.75.75h13.5a.75.75 0 00.75-.75v-1.5a.75.75 0 00-.75-.75H6a.75.75 0 00-.75.75v1.5z" />
    </svg>
);

export const LanguagesIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 21l5.25-11.25L21 21m-9-3h7.5M3 5.621a48.474 48.474 0 016-.371m0 0c1.12 0 2.233.038 3.334.114M9 5.25V3m3.334 2.364C13.18 7.36 14.25 9.75 15.373 12.313M9 5.25l-2.67 3.023m2.67-3.023L6.33 8.273M15.373 12.313l6.187 6.187M9 5.25l6.187 6.187" />
    </svg>
);
...
export const WhatsAppIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
        <path d="M16.6,14.2l-1.5-0.8c-0.2-0.1-0.4,0-0.5,0.2l-0.6,0.7c-0.5-0.3-1.3-0.7-2.2-1.6c-0.9-0.9-1.3-1.7-1.6-2.2l0.7-0.6 c0.2-0.2,0.2-0.3,0.2-0.5l-0.8-1.5C10.2,7.2,10,7,9.8,7H8.5C8.2,7,8,7.2,7.9,7.4C7.5,8,7,8.8,7,9.8c0,1.2,0.4,2.4,1.1,3.5 c1.4,2.2,3.6,3.7,5.7,3.7c1,0,1.8-0.5,2.5-0.9c0.2-0.1,0.3-0.3,0.3-0.6v-1.3C16.9,14.3,16.8,14.2,16.6,14.2z M12,2C6.5,2,2,6.5,2,12 c0,5.5,4.5,10,10,10c5.5,0,10-4.5,10-10C22,6.5,17.5,2,12,2z M12,20.5c-4.7,0-8.5-3.8-8.5-8.5c0-4.7,3.8-8.5,8.5-8.5 c4.7,0,8.5,3.8,8.5,8.5C20.5,16.7,16.7,20.5,12,20.5z" />
    </svg>
);
...
export const MtnIcon: React.FC<IconProps> = (props) => (
    <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" {...props}>
        ...
        <path d="M25,65 L25,35 L40,55 L55,35 L55,65" stroke="#004479" strokeWidth="8" fill="none" />
        <path d="M60,65 L75,35 L90,65" stroke="#ED1C24" strokeWidth="8" fill="none" />
    </svg>
);
export const VodafoneIcon: React.FC<IconProps> = (props) => (
    <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" {...props}>
        <circle cx="50" cy="50" r="48" fill="#E60000"/>
        <path d="M50 25 C 50 25, 70 45, 50 80 C 50 80, 30 45, 50 25 Z" fill="white"/>
    </svg>
);
export const AirtelTigoIcon: React.FC<IconProps> = (props) => (
    <svg viewBox="0 0 200 100" xmlns="http://www.w3.org/2000/svg" {...props}>
        <rect width="200" height="100" fill="#E30613"/>
        <path d="M40 70 L 60 30 L 80 70 M 50 55 H 70" stroke="white" strokeWidth="8" fill="none" />
        <path d="M110 30 V 70 M 110 50 H 130 L 140 70" stroke="white" strokeWidth="8" fill="none" />
    </svg>
);
...
export const MehIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M21 12a9 9 0 11-18 0 9 9 0 0118 0zM9 9.75h.008v.008H9V9.75zm6 0h.008v.008H15V9.75zM8.25 15h7.5" />
    </svg>
);

export const FrownIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M15.182 9.818a4.5 4.5 0 00-6.364 0M21 12a9 9 0 11-18 0 9 9 0 0118 0zM9 9.75h.008v.008H9V9.75zm6 0h.008v.008H15V9.75z" />
    </svg>
);
